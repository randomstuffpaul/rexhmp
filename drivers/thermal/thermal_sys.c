...
#define REBOOT_CMD_PATH_LEN 256
char reboot_cmd[REBOOT_CMD_PATH_LEN] = "/system/bin/reboot";

int emergency_reboot_system(void)
{
	char **argv;
	 static char *envp[] = {
		"HOME=/",
		"PATH=/sbin:/system/bin:/usr/sbin:/usr/bin",
		NULL
	};
	int ret;
