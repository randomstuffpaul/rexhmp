...
static struct dw_mci_board rex5260_dwmci0_pdata __initdata = {
	.num_slots		= 1,
	.ch_num			= 0,
...
static struct dw_mci_board rex5260_dwmci1_pdata __initdata = {
	.num_slots		= 1,
	.ch_num			= 1,
	.quirks                 =  DW_MCI_QUIRK_BROKEN_CARD_DETECTION | // eric.seo
	    			DW_MMC_QUIRK_NO_VOLSW_INT |
		    		DW_MCI_QUIRK_RETRY_DELAY |
		   		DW_MMC_QUIRK_SDIO_IRQ_LOCK_INTMASK |
	    			DW_MMC_QUIRK_FIXED_VOLTAGE |
	...
	.detect_delay_ms	= 200,
	.hclk_name		= "dwmci",
	.cd_type                = DW_MCI_CD_PERMANENT,//DW_MCI_CD_EXTERNAL, //eric.seo
	.cclk_name		= "sclk_dwmci",
...
static struct dw_mci_board rex5260_dwmci2_pdata __initdata = {
	.num_slots		= 1,
	.ch_num			= 2,
...
static struct platform_device *rex5260_mmc_devices[] __initdata = {
	&exynos5_device_dwmci0,
	&exynos5_device_dwmci1,
	&exynos5_device_dwmci2,
};

void __init exynos5_rex5260_mmc_init(void)
{
	exynos_dwmci_set_platdata(&rex5260_dwmci0_pdata, 0);
	exynos_dwmci_set_platdata(&rex5260_dwmci1_pdata, 1);
	exynos_dwmci_set_platdata(&rex5260_dwmci2_pdata, 2);

	platform_add_devices(rex5260_mmc_devices,
			ARRAY_SIZE(rex5260_mmc_devices));
}
