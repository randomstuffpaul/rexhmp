...
static struct s5p_mfc_qos rex5260_mfc_qos_table[] = {
	[0] = {
		.thrd_mb	= 0,
		.freq_mfc	= 134000,
		.freq_int	= 100000,
...
static struct s5p_mfc_platdata rex5260_mfc_pd = {
	.ip_ver		= IP_VER_MFC_6R_0,
	.clock_rate	= 333 * MHZ,
	.min_rate	= 84000, /* in KHz */
#ifdef CONFIG_ARM_EXYNOS5260_BUS_DEVFREQ
	.num_qos_steps	= ARRAY_SIZE(rex5260_mfc_qos_table),
	.qos_table	= rex5260_mfc_qos_table,
#endif
};

static struct exynos_scaler_platdata rex5260_mscl_pd = {
	.platid		= SCID_RH,
	.clk_rate	= 400 * MHZ,
	.gate_clk	= "mscl",
	.clk		= { "aclk_m2m_400", },
...
static struct platform_device *rex5260_media_devices[] __initdata = {
	&exynos_device_md0,
	&exynos_device_md1,
	&exynos5_device_gsc0,
	&exynos5_device_gsc1,
...
void __init exynos5_rex5260_media_init(void)
{
#ifdef CONFIG_VIDEO_EXYNOS_MFC
	s5p_mfc_set_platdata(&rex5260_mfc_pd);

	dev_set_name(&s5p_device_mfc.dev, "s3c-mfc");
	clk_add_alias("mfc", "s5p-mfc-v6", "mfc", &s5p_device_mfc.dev);
	s5p_mfc_setname(&s5p_device_mfc, "s5p-mfc-v6");
#endif
	platform_add_devices(rex5260_media_devices,
			ARRAY_SIZE(rex5260_media_devices));
	...
	s3c_set_platdata(&rex5260_mscl_pd, sizeof(rex5260_mscl_pd),
			&exynos5_device_scaler0);
	s3c_set_platdata(&rex5260_mscl_pd, sizeof(rex5260_mscl_pd),
			&exynos5_device_scaler1);
