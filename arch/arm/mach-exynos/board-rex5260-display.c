...
#define LCD_RESET EXYNOS5260_GPD0(6)
#define LCD_BLB  EXYNOS5260_GPD0(5)
#define LCD_PWMEN EXYNOS5260_GPD2(3)

#define TC_RESET    EXYNOS5260_GPD1(1)
static int mipi_lcd_power_control(struct mipi_dsim_device *dsim,
			unsigned int power)
{

    /* TC358764 Reset*/
    gpio_request_one(TC_RESET, GPIOF_OUT_INIT_HIGH, "TC Reset");
    s3c_gpio_setpull(TC_RESET, S3C_GPIO_PULL_UP);
    mdelay(100);
    gpio_set_value(TC_RESET, 0);
    mdelay(100);
    gpio_set_value(TC_RESET, 1);
    mdelay(100);
    gpio_free(TC_RESET);

    /* reset */
    gpio_request_one(LCD_RESET, GPIOF_OUT_INIT_HIGH, "LCD Reset");
    s3c_gpio_setpull(LCD_RESET, S3C_GPIO_PULL_UP);
    mdelay(100);
    ...
    gpio_free(LCD_RESET);
    /* power */
    gpio_request_one(LCD_BLB, GPIOF_OUT_INIT_LOW, "LCD BLB");
    s3c_gpio_setpull(LCD_BLB, S3C_GPIO_PULL_UP);
    gpio_set_value(LCD_BLB, power?1:0);
    gpio_free(LCD_BLB);
    /* PWM EN */
    gpio_request_one(LCD_PWMEN, GPIOF_OUT_INIT_LOW, "PWM En");
    s3c_gpio_setpull(LCD_PWMEN, S3C_GPIO_PULL_UP);
    gpio_set_value(LCD_PWMEN, power?1:0);
    gpio_free(LCD_PWMEN);

    return 1;
}

#define REX5260_HBP (150)
#define REX5260_HFP (26)
#define REX5260_HFP_DSIM (26)
#define REX5260_HSP (4)
#define REX5260_VBP (1)
#define REX5260_VFP (13)
#define REX5260_VSW (2)
#define REX5260_XRES (800)
#define REX5260_YRES (1280)
#define REX5260_VIRTUAL_X (800)
#define REX5260_VIRTUAL_Y (1280 * 2)
#define REX5260_WIDTH (71)
#define REX5260_HEIGHT (114)
#define REX5260_MAX_BPP (32)
#define REX5260_DEFAULT_BPP (24)

static struct s3c_fb_pd_win smdk5260_fb_win0 = {
    .win_mode = {
	.left_margin	= REX5260_HBP,
	.right_margin	= REX5260_HFP,
	.upper_margin	= REX5260_VBP,
	.lower_margin	= REX5260_VFP,
	.hsync_len	= REX5260_HSP,
	.vsync_len	= REX5260_VSW,
	.xres		= REX5260_XRES,
	.yres		= REX5260_YRES,
    },
    .virtual_x		= REX5260_VIRTUAL_X,
    .virtual_y		= REX5260_VIRTUAL_Y,
    .width			= REX5260_WIDTH,
    .height			= REX5260_HEIGHT,
    .max_bpp		= REX5260_MAX_BPP,
    .default_bpp		= REX5260_DEFAULT_BPP,
};
#elif defined(CONFIG_LCD_MIPI_ZJ070NA)

#define LCD_RESET EXYNOS5260_GPD2(4)
...
#define REX5260_HBP (138)
#define REX5260_HFP (34)
#define REX5260_HFP_DSIM (28)
#define REX5260_HSP (136)
#define REX5260_VBP (21)
#define REX5260_VFP (0x4)
#define REX5260_VSW (4)
#define REX5260_XRES (1024)
#define REX5260_YRES (600)
#define REX5260_VIRTUAL_X (1024)
#define REX5260_VIRTUAL_Y (600 * 2)
#define REX5260_WIDTH (71)
#define REX5260_HEIGHT (114)
#define REX5260_MAX_BPP (32)
#define REX5260_DEFAULT_BPP (24)
...
#define REX5260_HBP (1)
#define REX5260_HFP (1)
#define REX5260_HFP_DSIM (1)
#define REX5260_HSP (1)
#define REX5260_VBP (12)
#define REX5260_VFP (1)
#define REX5260_VSW (1)
#define REX5260_XRES (1920)
#define REX5260_YRES (1080)
#define REX5260_VIRTUAL_X (1920)
#define REX5260_VIRTUAL_Y (1080 * 2)
#define REX5260_WIDTH (71)
#define REX5260_HEIGHT (114)
#define REX5260_MAX_BPP (32)
#define REX5260_DEFAULT_BPP (24)
...
static void rex5260_lcd_on(void)
{
...
static void rex5260_lcd_off(void)
{
...
static struct plat_lcd_data rex5260_dp_lcd_data = {
	.set_power	= dp_lcd_set_power,
};

static struct platform_device rex5260_dp_lcd = {
	.name	= "platform-lcd",
	.dev	= {
		.parent		= &s5p_device_fimd1.dev,
		.platform_data	= &rex5260_dp_lcd_data,
	},
};

static struct s3c_fb_pd_win rex5260_fb_win0 = {
    .win_mode = {
	.left_margin	= 80,
	.right_margin	= 48,
	.upper_margin	= 52,
...
static void rex5260_fimd_gpio_setup_24bpp(void)
{
...
static struct s3c_fb_platdata smdk5260_lcd1_pdata __initdata = {
#if defined(CONFIG_S5P_DP)
	.win[0]		= &rex5260_fb_win0,
	.win[1]		= &rex5260_fb_win0,
	.win[2]		= &rex5260_fb_win0,
	.win[3]		= &rex5260_fb_win0,
	.win[4]		= &rex5260_fb_win0,
#else
	...
	.lcd_off	= rex5260_lcd_off,
#else
	.vidcon1	= VIDCON1_INV_VCLK,
#endif
	.setup_gpio	= rex5260_fimd_gpio_setup_24bpp,
	.ip_version	= EXYNOS5_813,
};

#ifdef CONFIG_FB_MIPI_DSIM
#define DSIM_L_MARGIN REX5260_HBP
#define DSIM_R_MARGIN REX5260_HFP_DSIM
#define DSIM_UP_MARGIN REX5260_VBP
#define DSIM_LOW_MARGIN REX5260_VFP
#define DSIM_HSYNC_LEN REX5260_HSP
#define DSIM_VSYNC_LEN REX5260_VSW
#define DSIM_WIDTH REX5260_XRES
#define DSIM_HEIGHT REX5260_YRES
...
#if defined(CONFIG_LCD_MIPI_ZJ070NA)
static struct mipi_dsim_config dsim_info = {
    .e_interface	= DSIM_VIDEO,
    .e_pixel_format = DSIM_24BPP_888,
    /* main frame fifo auto flush at VSYNC pulse */
    ...
    .dsim_ddi_pd = &zj070na_mipi_lcd_driver,
};
#endif
...
#ifdef CONFIG_S5P_DP
static struct video_info rex5260_dp_config = {
    .name			= "WXGA(1920x720) LCD, for MV TEST",
...
static struct s5p_dp_platdata rex5260_dp_data __initdata = {
	.video_info	= &rex5260_dp_config,
...
void __init exynos5_rex5260_display_init(void)
{
#ifdef CONFIG_S5P_DP
	int irq;
#endif
...
#endif
#ifdef CONFIG_S5P_DP
	s5p_dp_set_platdata(&rex5260_dp_data);
#endif
...
#ifdef CONFIG_S5P_DP
    irq = s5p_register_gpio_interrupt(EXYNOS5260_GPX0(7));
    if (IS_ERR_VALUE(irq)) {
	pr_err("%s: Failed to configure GPX0(7) GPIO\n", __func__);
	return;
    }
...
#if defined(CONFIG_LCD_MIPI_ZJ070NA)
    exynos5_fimd1_setup_clock(&s5p_device_fimd1.dev,
	    "sclk_fimd", "sclk_disp_pixel", 66 * MHZ);
#else
    exynos5_fimd1_setup_clock(&s5p_device_fimd1.dev,
