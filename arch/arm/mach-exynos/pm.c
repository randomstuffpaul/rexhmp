...
static void exynos_pm_prepare(void)
{
	...
	if (!(soc_is_exynos5250() || soc_is_exynos5410() || soc_is_exynos5260())) {
	...
	if (soc_is_exynos5410() || soc_is_exynos5260()) {
...
static int exynos_pm_suspend(void)
{
	...
	if (!(soc_is_exynos4210() || soc_is_exynos5410() || soc_is_exynos5260()))
		exynos_reset_assert_ctrl(false);
